            ...
            <div class="col-md-7">
                ...
                <div class="row">
                    <div class="col-md-3">
                         {{-- votos Rostros MP --}}
                         <div class="form-group">
                            <label for="vMiguel">Votos CANDIDATO A
                            </label>
                    ...
                    <div class="col-md-3">
                        {{-- votos Bandera  FMLN --}} 
                        <div class="form-group">
                           <label for="vFmln">Votos PARTIDO A 
                           </label>
                ...
                <div class="row">
                    <div class="col-md-3">
                         {{-- votos Rostros MP --}}
                         <div class="form-group">
                            <label for="vWill">Votos CANDIDATO B
                            </label>
                    ...
                    <div class="col-md-3">
                        {{-- votos Bandera  FMLN --}}
                        <div class="form-group">
                           <label for="vGanaNi">Votos COALICIÓN A 
                           </label>
                ...
                <div class="row">
                    <div class="col-md-3">
                         {{-- votos Rostros MP --}}
                         <div class="form-group">
                            <label for="vLuwin">Votos CANDIDATO C
                            </label>
                ...
                <div class="row">
                    <div class="col-md-3">
                         ...
                         <div class="form-group">
                            <label for="vMargarita">Votos  CANDIDATO D
                            </label>
                    ...
                    <div class="col-md-3">
                        {{-- votos Bandera  PDC --}}
                        <div class="form-group">
                           <label for="vPCN">Votos PARTIDO D
                           </label>
                ...
                <div class="row">
                    <div class="col-md-3">
                         {{-- votos Rostros Margarita --}}
                         <div class="form-group">
                            <label for="vReyes">Votos CANDIDATO E
                            </label>
                    ...
                    <div class="col-md-3">
                        {{-- votos Bandera  PDC --}}
                        <div class="form-group">
                           <label for="vPDC">Votos PARTIDO E
                           </label>
                ...
                <div class="row">
                    <div class="col-md-3">
                         {{-- votos Rostros Margarita --}}
                         <div class="form-group">
                            <label for="vGeovanni">Votos CANDIDATO F
                            </label>
               ...
               <div class="row">
                <div class="col-md-3">
                     {{-- votos Rostros Margarita --}}
                     <div class="form-group">
                        <label for="vMariaViera">Votos CANDIDATO G
                        </label>
                ...
                <div class="col-md-3">
                    {{-- votos Bandera  ARENA --}}
                    <div class="form-group">
                       <label for="vArena">Votos PARTIDO G
                       </label>
